...
import com.tuyue.miaodiyun.httpApiDemo.IndustrySMS;
...
public class PersonalCenterController {
    ...
    public Result forgetPwd(String userName, String passWord, String code, String phone) throws Exception {
        try {
            ...
            if (code.equals(s)) {
                ...
                return biz.forgetPwd(phone, passWord);
            } else {
                return ResultUtil.error(2, "验证码错误或者已过期");
            }
        } catch (Exception e) {
            e.getMessage();
            return ResultUtil.error(2, "验证码错误或者已过期");
    ...
    public Result phoneCode(String phone) {
        try {
            ...
            IndustrySMS.execute(phone, random);
            return ResultUtil.success("success");
        } catch (Exception e) {
            return ResultUtil.error(2, "ERROR");
        }
    }
}
